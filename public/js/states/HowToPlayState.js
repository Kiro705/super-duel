const HowToPlayState = {
    ...
    create: function() {
        ...
        game.add.text(65, 60, 'W,A,S,D for Player 1 and Arrow Keys for Player 2', {font: '24pt Impact', fill: 'gold'})
        game.add.text(65, 140, 'Move Left or Right with those Arrow Keys', {font: '24pt Impact', fill: 'gold'})
        game.add.text(65, 220, 'Jump or Double Jump with the Up Arrow', {font: '24pt Impact', fill: 'gold'})
        game.add.text(65, 300, 'Down + Left or Down + Right to Attack in that direction', {font: '24pt Impact', fill: 'gold'})
        game.add.text(65, 380, 'Get the Power-Ups to help defeat your opponent', {font: '24pt Impact', fill: 'gold'})
        game.add.text(65, 460, 'Spacebar to select and Backspace to go back', {font: '24pt Impact', fill: 'gold'})
